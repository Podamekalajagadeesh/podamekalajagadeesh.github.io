...
const CircuitBackground = () => {
  return (
    <>
      ...
      <svg className="bg-react-symbol react-4" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        <circle cx="50" cy="50" r="8" fill="var(--neon-cyan)"/>
        <ellipse cx="50" cy="50" rx="30" ry="8" fill="none" stroke="var(--neon-cyan)" strokeWidth="2" transform="rotate(0 50 50)"/>
        <ellipse cx="50" cy="50" rx="30" ry="8" fill="none" stroke="var(--neon-cyan)" strokeWidth="2" transform="rotate(60 50 50)"/>
        <ellipse cx="50" cy="50" rx="30" ry="8" fill="none" stroke="var(--neon-cyan)" strokeWidth="2" transform="rotate(120 50 50)"/>
      </svg>
      <svg className="bg-react-symbol react-5" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        <circle cx="50" cy="50" r="8" fill="var(--neon-cyan)"/>
        <ellipse cx="50" cy="50" rx="30" ry="8" fill="none" stroke="var(--neon-cyan)" strokeWidth="2" transform="rotate(0 50 50)"/>
        <ellipse cx="50" cy="50" rx="30" ry="8" fill="none" stroke="var(--neon-cyan)" strokeWidth="2" transform="rotate(60 50 50)"/>
        <ellipse cx="50" cy="50" rx="30" ry="8" fill="none" stroke="var(--neon-cyan)" strokeWidth="2" transform="rotate(120 50 50)"/>
      ...
      <svg className="bg-ethereum-symbol eth-4" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        <polygon points="50,20 30,50 50,45 70,50" fill="var(--neon-cyan)"/>
        <polygon points="50,45 30,50 50,80 70,50" fill="var(--neon-blue)"/>
      </svg>
      <svg className="bg-ethereum-symbol eth-5" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        <polygon points="50,20 30,50 50,45 70,50" fill="var(--neon-cyan)"/>
        <polygon points="50,45 30,50 50,80 70,50" fill="var(--neon-blue)"/>
      </svg>
      <svg className="bg-ethereum-symbol eth-6" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        <polygon points="50,20 30,50 50,45 70,50" fill="var(--neon-cyan)"/>
        <polygon points="50,45 30,50 50,80 70,50" fill="var(--neon-blue)"/>
      </svg>
